...
def home_detail(request,hid):
    ...
    if u_id:
        ...
        return render(request,'detail/detail.html',{"home_info":home_info,"pic":pic,"comment":comment,'all_home':all_home})
...
def comment(request,hid):
    ...
    if request.method == "GET":
        ...
        if u_id == Order.order_fk_user:
            ...
            return render(request,'detail/jump2.html')
