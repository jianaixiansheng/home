...
class men(models.Model):
    ...
    men_fk = models.ForeignKey('UserInfo',on_delete=models.CASCADE)
    men_fk_house = models.ForeignKey('house',on_delete=models.CASCADE)
    men_fk_order = models.ForeignKey('Order',on_delete=models.CASCADE)