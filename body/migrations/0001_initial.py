# Generated by Django 2.1.2 on 2019-08-04 13:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic_fk', models.ForeignKey('house',on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='men',
        ...
        migrations.AddField(
            model_name='men',
            name='men_fk',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='body.UserInfo'),
        ),
        migrations.AddField(
            model_name='men',
            name='men_fk_house',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='body.house'),
        ),
        migrations.AddField(
            model_name='men',
            name='men_fk_order',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='body.Order'),
        ),
        migrations.AddField(
            model_name='house',
            name='house_fk',
