    ...
    var calendarSwitch = (function() {
        ...
        calendarSwitch.prototype = { /*说明：初始化插件*/
            ...
            init: function() {
                ...
                var html = "<div class='headerWrapper'><div class='headerTip'>请选择日期</div><div class='comfire'>完成</div></div><table class='dateZone'><tr><td class='colo'>日</td><td>一</td><td>二</td><td>三</td><td>四</td><td>五</td><td class='colo'>六</td></tr></table>" + "<div class='tbody'></div>"
            ...
            _initselected: function() {
                ...
                tds.each(function(index, element) {
                    if ($(this).text() == strDays) {
                        ...
                        if ($(this).next().text() != "") {
                            $(this).next().append('</br><p class="rz">离开</p>');
                        } else {
                            $(".dateTable").eq(1).find("td").each(function(index, el) {
                                if ($(this).text() != "") {
                                    $(this).append('</br><p class="rz">离开</p>');
                                    return false;
                                }
                            });
                        }
                ...
                $(arry1).on('click', function(index) {
                    ...
                    if (flag == 0) {
                        ...
                        $(me.sections).find('.rz').each(function(index, element) {
                            if ($(this).text() == '入住') {
                                $(this).parent('td').append('<span class="hover ruzhu_hover">选择离开日期</span>');
